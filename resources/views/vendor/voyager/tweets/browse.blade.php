...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <ul class="list-group">
                <li class="list-group-item">شسشس <span class="label label-danger">فرئخته شد</span></li>
                <li class="list-group-item">سلب <span class="label label-danger">ثقل </span></li>
                <li class="list-group-item">ثصبثب <span class="badge">3</span></li>
            </ul>
        </div>
    </div>
